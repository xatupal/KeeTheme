...
$url = 'https://github.com/xatupal/KeeTheme/releases/download/v0.10.8/KeeTheme.plgx'
$checksum = '156D9A118F6118E4C5A0D831B4F3A4E2C697527EAFFB449405AD011800D7284E'
$checksumType = 'sha256'
