...
$url = 'https://github.com/xatupal/KeeTheme/releases/download/v0.10.0/KeeTheme.plgx'
$checksum = '56136B3FC96D6100935BAC9A67E67B44EDA3056749B8F40CF897CBA534F5AFD1'
$checksumType = 'sha256'
