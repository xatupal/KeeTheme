...
$url = 'https://github.com/xatupal/KeeTheme/releases/download/v0.9.12/KeeTheme.plgx'
$checksum = 'ED7C6B07A300189B7EDC4CD5CE54B1ED73AB95618E9512A1E36699BF1B8E66B8'
$checksumType = 'sha256'
