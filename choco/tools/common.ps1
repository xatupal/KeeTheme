...
$url = 'https://github.com/xatupal/KeeTheme/releases/download/v0.6.11/KeeTheme.plgx'
$checksum = '4BD28CBE9C474B2DA317F8B412EAE0F3119077A3694585EC5F0580AD65269941'
$checksumType = 'sha256'
