...
$url = 'https://github.com/xatupal/KeeTheme/releases/download/v0.10.3/KeeTheme.plgx'
$checksum = '42188BD7BF37075310A4EC41A76BA076B8048F10D4B0C156BEE9084808560D98'
$checksumType = 'sha256'
