...
$url = 'https://github.com/xatupal/KeeTheme/releases/download/v0.6.10/KeeTheme.plgx'
$checksum = '18C65D3E1881F7E9AEF2378FAECCDF5B2DE2CA7C404664AE6CC909DD8920A6B6'
$checksumType = 'sha256'
